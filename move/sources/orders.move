module haigo::orders {
    ...
    // Public entry wrapper for initialization. Safe to call multiple times.
    // If OrderBook already exists, this is a no-op.
    public entry fun init_orders_entry(admin: &signer) {
